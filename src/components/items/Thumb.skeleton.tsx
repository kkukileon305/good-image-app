...
const ThumbSkeleton = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className='w-full flex flex-col gap-4 items-center sm:flex-row sm:items-stretch justify-between p-4 shadow-md border rounded-xl overflow-hidden'>
      <div className='w-[200px] h-[300px] bg-gray-400' />
      <div className='w-full sm:w-[calc(100%-216px)] flex flex-col gap-2'>
